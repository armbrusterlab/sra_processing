...
# From https://github.com/OpenGene/fastp/blob/master/parallel.py, lightly modified by me
# (default values of read1_flag and read2_flag changed from R1 and R2 to _1 and _2 because they were causing issues with report file names, e.g. SRR12345 -> SRpe2345)
...
def parseCommand():
    ...
    parser.add_option("-1", "--read1_flag", dest = "read1_flag", default = "_1",
        help = "specify the name flag of read1, default is R1, which means a file with name *R1* is read1 file")
    parser.add_option("-2", "--read2_flag", dest = "read2_flag", default = "_2",
